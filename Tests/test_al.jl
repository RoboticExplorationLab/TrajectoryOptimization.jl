...
#plot(results4.cost[1:results4.termination_index])
...
X_interp = iLQR.line_trajectory(solver6!.obj.x0,solver6!.obj.xf,solver6!.N)
...
plot(results6.cost,color="red")
results6.cost

plot(results6.time,color="blue")
println("mean iteration time: $(mean(results6.time))s")
