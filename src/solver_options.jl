...
mutable struct SolverOptions
    ...
    outer_loop_update_type::Symbol # type of outer loop update (default, individual)
    ...
    use_λ_second_order_update::Bool # second order update for Lagrange multipliers once sqrt(cost tolerance | gradient) < desired tolerance
