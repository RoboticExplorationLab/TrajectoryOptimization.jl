...
mutable struct SolverOptions
    ...
    function SolverOptions(;square_root=false,verbose=false,
        ...
        iterations_linesearch=25,mu_reg_update=1e-3,mu_al_update=100.0,infeasible_regularization=1000.0,cache=false,
        ...
        iterations_linesearch,mu_reg_update,mu_al_update,infeasible_regularization,cache,benchmark,infeasible)
    end
end
