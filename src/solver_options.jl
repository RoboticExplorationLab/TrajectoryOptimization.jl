...
mutable struct SolverOptions
    ...
    function SolverOptions(;constrained=false,minimum_time=false,infeasible=false,square_root=false,verbose=false,
        ...
        constraint_tolerance=1.0e-3,iterations=500,iterations_innerloop=150,iterations_outerloop=50,
        iterations_linesearch=15,R_infeasible=10.0,R_minimum_time=10.0,
        ...
        ρ_initial=0.0,ρ_factor=1.6,ρ_max=1.0e8,ρ_min=1e-6,regularization_type=:state,ρ_forwardpass=10.0,eigenvalue_scaling=2.0,eigenvalue_threshold=1e-8,use_static=false,live_plotting=false,active_set=false,active_set_flag=false,active_set_tolerance=1e-8,active_constraint_tolerance=1e-12)
