...
mutable struct SolverOptions
    ...
    function SolverOptions(;square_root=false,verbose=false,
        c1=1.0e-8,c2=2.0,max_state_value=1.0e16,max_control_value=1.0e16,max_dt=1.0,min_time_init=0,gradient_tolerance=1e-5,gradient_intermediate_tolerance=1e-5,cost_tolerance=1.0e-5,cost_intermediate_tolerance=1.0e-2,
