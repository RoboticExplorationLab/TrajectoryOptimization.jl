...
mutable struct SolverOptions
    ...
    function SolverOptions(;square_root=false,verbose=false,
        c1=1.0e-8,c2=2.0,max_state_value=1.0e16,max_control_value=1.0e16,gradient_tolerance=1e-6,eps=1.0e-5,eps_intermediate=1.0e-2,
        ...
        new(square_root,verbose,c1,c2,max_state_value,max_control_value,gradient_tolerance,eps,eps_intermediate,
