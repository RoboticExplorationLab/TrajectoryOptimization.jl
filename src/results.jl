...
# {N,M,P,PN,NM,NN,MM,PP,PPN,NP,MP,NPN}
...
struct ConstrainedVectorResults <: ConstrainedIterResults
    ...
    LAMBDA::Vector{Vector{Float64}} # Lagrange multipliers (p,N)
    MU::Vector{Vector{Float64}}     # Penalty terms (p,N)
